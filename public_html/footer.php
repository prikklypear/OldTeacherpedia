        ...
        <!-- Footer -->
<div id="boostrap-override">        
<footer class="navbar navbar-default font-small pt-4" id="footer">
    ...
    <!-- Copyright -->
    <div class="footer-copyright text-center py-3">© 2018 Copyright: Mark Pearson 2018
    </div>
    <!-- Copyright -->
